...
import com.divergent.springmvc.service.AppointmentService;
/**
...
public class AppointmentController {
	...
	/*
	 * @GetMapping("/remove") protected String delete(HttpServletRequest req,
	 * HttpServletResponse resp) throws ServletException, IOException {
	 * 
	 * int appointmentId = Integer.parseInt(req.getParameter("appointmentId"));
	 * appointmentService.remove(appointmentId); return "redirect:/appointment";
	 * 
	 * 
	 * }
	 */
